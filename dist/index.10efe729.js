...
})({"kwOK3":[function(require,module,exports) {
...
module.bundle.HMR_BUNDLE_ID = "cde2fa8610efe729";
"use strict";
...
document.addEventListener("DOMContentLoaded", function() {
    loadPage("first.html", function() {
        document.addEventListener("click", function(event) {
            ...
            // 뒤로가기
            if (event.target.classList.contains("select-prev")) loadPage("select.html");
            if (event.target.classList.contains("season-prev")) loadPage(sessionStorage.getItem("selectedSeason"));
            // 완성하기
...
//# sourceMappingURL=index.10efe729.js.map
